...
public class RegistrationServiceImpl implements RegistrationService {
  ...
  public void registrationUser(RegistrationForm form) {
    ...
    String mailText = "<a href=\"http://localhost:8080/confirm/" + confirmString + "\">Подтвердить</a>";

    emailService.sendMail(newUser.getEmail(), "Перейти на темную сторону", mailText);
